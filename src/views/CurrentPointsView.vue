  ...
  <div class="game-points col-md-12">
    ...
    <div v-if="teamPlayers != null">
      <div class="summoners-rift mx-auto">
        <div
          class="player-card"
          v-for="player in playersForSummonersRiftView"
          :key="player.id"
        ...
        >
          ...
          <div class="player-info">
            ...
            <div v-if="!player.captain" class="player-points">
              {{ player.points.toFixed(2) }}
            </div>
            <div v-if="player.captain" class="player-points">
              <span class="crossed">{{ player.points.toFixed(2) }}</span
              ><br />{{ player.points.toFixed(2) * 2 }}
            </div>
          </div>
        ...
        <div class="player-card" :style="getTeamPosition()">
          <img
            :src="teamPlayers.teamPoints.team.imageUrl"
            :alt="teamPlayers.teamPoints.team.name"
            class="player-image"
          />
          <div class="player-info">
            <div class="player-name">
              {{ teamPlayers.teamPoints.team.name }}
            </div>
            <!-- or code-->
            <div class="player-points">
              {{ teamPlayers.teamPoints.totalPoints.toFixed(2) }}
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="row justify-content-md-center">
        <div
          class="col-1 d-flex justify-content-end sticky-end"
          v-if="teamPlayers != null"
        >
          <button class="btn btn-info btn-purple" @click="scrollLeft">
            &lt;
          </button>
        </div>
        <div class="col-8">
          ...
          >
            ...
            <TeamPointsGamesCard
              ...
              :gamesList="fixtureGames"
              :key="teamPlayers"
              :gamesPointsDetails="teamPlayers.teamPoints.gamesPointsDetails"
        ...
        <div
          class="col-1 d-flex justify-content-start sticky-start"
          v-if="teamPlayers != null"
        >
          <button class="btn btn-info btn-purple" @click="scrollRight">
            >
          </button>
        </div>
      </div>
