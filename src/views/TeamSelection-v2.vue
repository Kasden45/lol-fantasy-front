...
<template>
  <div class="container">
    ...
    <div class="row w-100 justify-content-md-center m-auto">
      ...
      >
        <div class="row">
          ...
          <div
            class="progress-ring col-4 offset-2 d-flex align-content-center"
            v-if="this.nextFixture != null"
          >
            <svg
                ...
                <text
                  ...
                  :class="{
                    'fill-primary':
                      this.teamValue <= this.nextFixture.fixture.teamValueLimit,
                    'fill-error':
                      this.selectedUserTeam.chipActivated != 2 &&
                      this.teamValue > this.nextFixture.fixture.teamValueLimit,
                  }"
                  class="progress-ring__text"
                  :x="center"
                  ...
                  {{
                    this.selectedUserTeam.chipActivated == 2
                      ...
                      : `$${
                        ...
                        } / $${this.nextFixture.fixture.teamValueLimit}`
                  }}
                </text>
              </g>
            </svg>
          ...
          <div
            class="progress-ring offset-2 col-4 d-flex align-content-start"
            v-if="this.nextFixture != null"
          >
            <svg
              class="progress-ring__svg"
            ...
            >
              ...
              <g transform="rotate(90, 165, 165)">
                <text
                  :class="{
                    'fill-primary':
                      this.selectedUserTeam.transfersAvailable -
                        this.transfersMade >=
                      0,
                    'fill-error':
                      this.selectedUserTeam.chipActivated != 2 &&
                      this.selectedUserTeam.chipActivated != 3 &&
                      this.selectedUserTeam.transfersAvailable -
                        this.transfersMade <
                        0,
                  }"
                ...
                >
                  {{
                    this.selectedUserTeam.chipActivated == 3 ||
                    this.selectedUserTeam.chipActivated == 2 ||
                    this.selectedUserTeam.transfersAvailable > 10
                      ? "∞"
                      : `${
                          this.selectedUserTeam.transfersAvailable -
                          this.transfersMade
                        } / ${this.nextFixture.fixture.transfersLimit}`
                  }}
                </text>
              </g>
            </svg>
        ...
        <div class="" v-if="selectedTabIndex == 2">
          <TeamsListV2
            :currentFixture="this.lastPlayedFixture"
            :userTeam="
              selectedUserTeam.team.team != null
                ? selectedUserTeam.team.team.slug
                : ''
            "
            :nextFixture="nextFixture"
            :teamsPlayingNextFixture="teamsPlayingInNextFixture"
    ...
    <button
      class="btn btn-info my-2 col-6 w-100"
      @click="this.showMatches = !this.showMatches"
    >
      {{ this.showMatches ? "Hide matches" : "Show matches" }}
    </button>
    <div
      v-if="this.showMatches && this.nextFixture != null"
  ...
  computed: {
      ...
      this.allPlayers.forEach((player) => {
        ...
        if (playerMatch != null) {
          rivals[player.esportsPlayerId] =
            playerMatch.team1.code === player.team.code
              ? playerMatch.team2.code
              : playerMatch.team1.code;
        }
        player.opponent =
          playerMatch != null
            ? playerMatch.team1.code === player.team.code
    ...
    teamsRivals() {
      ...
      this.allTeams.forEach((team) => {
        ...
        if (teamMatch != null) {
          rivals[team.code] =
            teamMatch.team1.code === team.code
              ? teamMatch.team2.code
              : teamMatch.team1.code;
          team.opponent =
            teamMatch.team1.code === team.code
              ? teamMatch.team2.code
              : teamMatch.team1.code;
    ...
    strokeDashoffsetTransfer() {
      ...
      if (
        ...
        percent =
          (this.selectedUserTeam.transfersAvailable - this.transfersMade) /
          this.nextFixture.fixture.transfersLimit;
      }
      return this.circumference - percent * this.circumference;
    },
    teamIsCorrect() {
      return !(
        (this.teamValue > this.nextFixture.fixture.teamValueLimit &&
          this.selectedUserTeam.chipActivated != 2) ||
        (this.transfersMade > this.selectedUserTeam.transfersAvailable &&
          this.selectedUserTeam.chipActivated != 2 &&
          this.selectedUserTeam.chipActivated != 3) ||
        this.pickedPlayersNumber < 7
      );
    },
    pickedPlayersIds() {
      let pickedPlayers = [];
    ...
    pickedPlayersNumber() {
      ...
      // eslint-disable-next-line
      if (
        this.selectedUserTeam.hasOwnProperty("team") &&
  ...
  methods: {
    ...
    submitTeamPost() {
      ...
      const data = {
        ...
        junglePlayerId:
          this.selectedUserTeam.junglePlayer.player.esportsPlayerId,
        ...
        supportPlayerId:
          this.selectedUserTeam.supportPlayer.player.esportsPlayerId,
        ...
        chipUsed:
          this.selectedUserTeam.chipActivated != null
            ? this.selectedUserTeam.chipActivated
            : 0,
      };
    ...
    validateTeam() {
      return (
        this.selectedUserTeam.topPlayer.player != null &&
