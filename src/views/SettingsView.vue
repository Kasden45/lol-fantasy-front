        ...
        <table>
          ...
          <tbody>
            <tr
              ...
              v-for="setting in this.userSettings.settings"
              ...
              <td>
                <div class="form-check form-switch">
                  <input
                    ...
                    v-on:change="updateSetting(setting.userSettingId)"
    ...
    getSettings() {
      ...
      this.axios
        ...
        .then((response) => {
          ...
          this.userSettings.settings[0].value =
            this.userSettings.settings[0].value == 1 ? true : false;
        })
        .catch((error) => {
