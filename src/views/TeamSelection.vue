...
<template>
  <div class="container">
    ...
    <div class="row">
      <div
        class="progress-ring col-3 offset-1 d-flex align-content-start"
      ...
      <div
        class="progress-ring col-4 d-flex align-content-start"
        v-if="this.nextFixture != null"
      >
        <svg
          class="progress-ring__svg"
      ...
      <div class="col-4 d-flex align-items-end">
        ...
        >
          Next deadline:
          {{
            this.$func_global.formatDate(this.nextFixture.fixture.deadlineDate)
          }}
        </h4>
            ...
            >
              <option
                v-for="fixtureOrder in Array.from(
                  Array(nextFixture.fixture.order - 1).keys()
                )"
                :key="order"
                :value="fixtureOrder"
              >
  ...
  computed: {
    ...
    teamIsCorrect() {
      return !(
        this.teamValue > this.nextFixture.fixture.teamValueLimit ||
        this.selectedUserTeam.transfersAvailable <
          this.selectedUserTeam.transfersMade ||
