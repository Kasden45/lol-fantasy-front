<template>
  <div
    id="panel"
    class="justify-content-center align-content-center w-50 mx-auto"
  >
    <div class="mb-1">
      <!-- <div class="col-3 text-center align-content-center mb-2"> -->
      <label class="form-label text-start fw-bolder" for="login-mail"
        >Adres e-mail:</label
      >
      <!-- </div> -->
    ...
    <div class="w-auto mb-1">
      ...
      <label class="form-label text-start fw-bolder" for="login-password"
        >Hasło:</label
      >
      <!-- </div> -->
      <!-- <div class="col-8 text-center mb-2"> -->
    ...
    <div class="w-auto text-end">
      <p v-if="wrongLoginData" class="has-error">Niepoprawne dane logowania!</p>
          ...
          <div class="modal-content">
            <div class="modal-header">
              <h5 id="registerModalLabel" class="modal-title ms-2">
                {{ !successRegister ? "Podaj dane do rejestracji" : "" }}
              </h5>
              <button
                aria-label="Close"
                class="btn-close"
            ...
            <div class="modal-body">
              <div id="modal-container" class="container-fluid">
                <div v-if="!successRegister" class="col-11 mx-auto">
                  <div class="row">
                    <label class="form-label text-start" for="register-mail"
                      >Adres e-mail:</label
                    >
                    <input
                      id="register-mail"
                      ...
                      :class="{
                        'has-error':
                          (submittingRegister && invalidNewEmail) || emailTaken,
                      }"
                  ...
                  <div class="row mt-2">
                    <label class="form-label text-start" for="register-password"
                      >Hasło:</label
                    >
                    <input
                      ...
                      :class="{
                        'has-error':
                          submittingRegister &&
                          (invalidNewPassword || invalidEqualPassword),
                      }"
                      class="register-input p-2"
                      placeholder="Hasło"
                      type="password"
                  ...
                  <div class="row mt-2">
                    ...
                    <input
                      ...
                      :class="{
                        'has-error':
                          submittingRegister &&
                          (invalidNewPasswordSecond || invalidEqualPassword),
                      }"
                      class="register-input p-2"
                  ...
                  <div class="row mt-2">
                    <label class="form-label text-start" for="rnewLogin"
                      >Login</label
                    >
                    <input
                      id="newLogin"
                  ...
                  <div v-if="errorEqualPassword" class="row text-end">
                    <p class="has-error m-0">Podane hasła się różnią!</p>
                  </div>
                  <div class="row justify-content-center mt-5">
                    <div class="col-6">
                      <button
                        class="register-btn grey-btn p-2"
                        data-bs-dismiss="modal"
                        @click="
                          clearInputs();
                          clearStatusWithTimeout();
                    ...
                    <div class="col-6">
                      <button
                        class="register-btn pink-btn p-2"
                        @click="register"
                      >
                        Rejestruj
                      </button>
                ...
                <div v-if="successRegister" class="col-11 mx-auto">
                  ...
                  <p>Możesz zalogować się swoimi danymi.</p>
                </div>
              </div>
            </div>
          </div>
