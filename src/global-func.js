...
export const func_global = {
  ...
  leagues_icons: {
    "LTA North":
      "https://static.lolesports.com/leagues/1731566778368_LTANORTH-LOGO_Blue_RGB2000px.png",
    "LTA South":
      "https://static.lolesports.com/leagues/1731566868757_LTASOUTH-LOGO_Red_RGB2000px.png",
    ...
    WORLDS:
      "https://static.lolesports.com/leagues/1592594612171_WorldsDarkBG.png",
  ...
  async uploadFileFunc(data, type, token, id) {
    let url;
    if (type === "roleRequest") url = `${apiURL}role-request/import/${id}/`;
    else if (type === "profilePicture") url = `${apiURL}profile/import`;
    else if (type === "postPicture") url = `${apiURL}post/import/${id}`;
    else if (type === "dishPicture") url = `${apiURL}dish/${id}/photo`;
    else if (type === "importProducts") url = `${apiURL}import/products`;
    else if (type === "importDiets") url = `${apiURL}import/diets`;
    else if (type === "importAilments") url = `${apiURL}import/ailments`;
  ...
  mapPublished(draft) {
    if (draft) return "Szkic";
    else return "Opublikowane";
  },
  mapDay(day) {
    if (day == "MONDAY") return "Poniedziałek";
    else if (day == "TUESDAY") return "Wtorek";
    else if (day == "WEDNESDAY") return "Środa";
    else if (day == "THURSDAY") return "Czwartek";
    else if (day == "FRIDAY") return "Piątek";
    else if (day == "SATURDAY") return "Sobota";
    else if (day == "SUNDAY") return "Niedziela";
  },
  days: [
    {
      num: 1,
