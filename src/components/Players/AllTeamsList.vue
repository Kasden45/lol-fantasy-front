      ...
      <tr
        v-for="team in sortedTeams.filter(
          (t) =>
            t.price > 0 &&
            (!hideInactive ||
              (hideInactive && this.teamsPlayingNextFixture.includes(t.code)))
        )"
      ...
      >
        ...
        >
          {{
            team.gamesPlayed == 0
              ? "-"
              : (team.points / team.gamesPlayed).toFixed(0)
          }}
        </td>
        <td
          class="text-center"
        ...
        >
          {{
            team.gamesPlayed == 0
              ? "-"
              : (team.points / team.gamesPlayed / team.price).toFixed(2)
          }}
        </td>
        <td
          class="text-center"
        ...
        <td>
          <button
            :class="{
              'btn-secondary': selectedRole != 'team',
              'btn-info':
                selectedRole == 'team' &&
