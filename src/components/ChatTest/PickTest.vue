  <template>
    <div class="container">
      <button class="cta-btn" @click="joinDraft" v-if="!this.draftStarted && !this.draftParticipants.map(p => p.id).includes(this.$store.getters.getProfileId)">Join Draft</button>
      <button class="cta-btn" @click="startDraft" v-if="!this.draftStarted && this.draftParticipants.map(p => p.id).includes(this.$store.getters.getProfileId)">Start Draft</button>
      <div>
        <a v-if="!this.draftStarted && this.draftParticipants.map(p => p.id).includes(this.$store.getters.getProfileId)">Players waiting for draft: {{ this.draftParticipants.map(p => p.username) }}</a>
      </div>
      ...
      <div class="draft-container justify-content-md-center m-auto row">
        ...
        <TeamRoster class="players-list-container user-team col-6"
        ...
        <div class="players-list-container col-6" >
          ...
          <div class="accordion" id="otherTeamsAccordion">
            <div class="accordion-item" v-for="(team, clientId) in otherTeams" :key="clientId">
              <h2 class="accordion-header">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" :data-bs-target="`#collapse${clientId}`">
                  Team {{ draftParticipants.find(p => p.id == clientId) ? `${draftParticipants.find(p => p.id == clientId).username}` : '' }}
                </button>
              </h2>
              <div :id="`collapse${clientId}`" class="accordion-collapse collapse" data-bs-parent="#otherTeamsAccordion">
                <div class="accordion-body">
                  <TeamRoster class="players-list-container rival-team col-12"
                    ...
                    :nextFixture="nextFixture" 
                    :own-team="false"
                    :rivalName="draftParticipants.find(p => p.id == clientId) ? `${draftParticipants.find(p => p.id == clientId).username}` : 'Unknown'"
                    :selectedRole="roleToAddPlayer"
                    @choose-role=""
                    @remove-player=""
                  />
  ...
  export default {
    ...
    data() {
      ...
      selectedTeam: {
        ...
        midPlayer: { role: "mid", player: {"esportsPlayerId":"99871276342168416","firstName":"Jihun","lastName":"Jung","summonerName":"Chovy","role":"mid","imageUrl":"http://static.lolesports.com/players/1686474439543_GEN_Chovy.png","nationality":"South Korea","price":100,"points":0,"gamesPlayed":0,"matchesPlayed":0,"team":{"esportsTeamId":"100205573495116443","slug":"geng","name":"Gen.G Esports","region":"KOREA","league":"LCK","code":"GEN","imageUrl":"http://static.lolesports.com/teams/1655210113163_GenG_logo_200407-05.png","backgroundImageUrl":"https://lolstatic-a.akamaihd.net/esports-assets/production/team/geng-bnm75bf5.png","price":15,"gamesPlayed":0,"matchesPlayed":0,"points":0}} },
        ...
        draftQueue: [],
        otherTeams: {"123": {
          topPlayer: { role: "top", player: {"esportsPlayerId":"99871276342168416","firstName":"Jihun","lastName":"Jung","summonerName":"Chovy","role":"mid","imageUrl":"http://static.lolesports.com/players/1686474439543_GEN_Chovy.png","nationality":"South Korea","price":100,"points":0,"gamesPlayed":0,"matchesPlayed":0,"team":{"esportsTeamId":"100205573495116443","slug":"geng","name":"Gen.G Esports","region":"KOREA","league":"LCK","code":"GEN","imageUrl":"http://static.lolesports.com/teams/1655210113163_GenG_logo_200407-05.png","backgroundImageUrl":"https://lolstatic-a.akamaihd.net/esports-assets/production/team/geng-bnm75bf5.png","price":15,"gamesPlayed":0,"matchesPlayed":0,"points":0}} },
          junglePlayer: { role: "jungle", player: null },
    ...
    async created() {
      ...
      socket.on('currentState', ({pickedPlayers, draftParticipants, currentDrafter, draftQueue, draftStarted}) => {
    ...
    methods: {
        ...
        async getFixtures() {
            ...
            this.axios.get(url).then((response) => {
                  ...
                  "matches": [
                      {
                          ...
                          "team1": {
                              "wins": 0,
                              "imageUrl": "http://static.lolesports.com/teams/1767340467921_DN_SOOPerslogo_profile.webp",
                              "name": "DN FREECS",
                              "code": "DNS"
                          },
                          "team2": {
                              "wins": 0,
                              "imageUrl": "http://static.lolesports.com/teams/1726801573959_539px-T1_2019_full_allmode.png",
                              "name": "T1",
                              "code": "T1"
                          }
                      },
                      {
                          ...
                          "team1": {
                              "wins": 0,
                              "imageUrl": "http://static.lolesports.com/teams/1655210113163_GenG_logo_200407-05.png",
                              "name": "Gen.G Esports",
                              "code": "GEN"
                          },
                          "team2": {
                              "wins": 0,
                              "imageUrl": "http://static.lolesports.com/teams/1631819564399_hle-2021-worlds.png",
                        ...
                        },
                        {
                          ...
                          "team1": {
                            "wins": 0,
                            "imageUrl": "http://static.lolesports.com/teams/1672910733664_01.Basic_W.png",
                            "name": "DRX",
                            "code": "DRX"
                          },
                          "team2": {
                            "wins": 0,
                            "imageUrl": "http://static.lolesports.com/teams/NSFullonDark.png",
                        ...
                        },
                        {
                          ...
                          "team1": {
                            "wins": 0,
                            "imageUrl": "http://static.lolesports.com/teams/kt_darkbackground.png",
                            "name": "kt Rolster",
                            "code": "KT"
                          },
                          "team2": {
                            "wins": 0,
                            "imageUrl": "http://static.lolesports.com/teams/1673260049703_DPlusKIALOGO11.png",
                            "name": "Dplus KIA",
                            "code": "DK"
                          }
                        },
                        {
                          ...
                          "team1": {
                            "wins": 0,
                            "imageUrl": "http://static.lolesports.com/teams/1716454325887_Nowyprojekt.png",
                            "name": "OKSavingsBank BRION",
                            "code": "BRO"
                          },
                          "team2": {
                            "wins": 0,
                            "imageUrl": "http://static.lolesports.com/teams/1734691810721_BFXfullcolorfordarkbg.png",
                            "name": "BNK FEARX",
                            "code": "BFX"
                          }
                        } ]
                ...
                if(this.nextFixture != null) {
                  ...
                  .map(m => m.code);
                  console.log("teams playing in next fixture", this.teamsPlayingInNextFixture);
                }
      ...
      selectTeam(team) {
          ...
          // this.availablePlayers = this.availablePlayers.filter(p => p.esportsPlayerId !== player.esportsPlayerId);
          socket.emit('teamSelected', { clientId: userId, team: team, invitationCode: this.leagueId, role: this.roleToAddPlayer });
      },
      ...
      teamSelected (team){
          ...
          console.log("trying to add team ",team.name, ' to ', this.roleToAddPlayer);
