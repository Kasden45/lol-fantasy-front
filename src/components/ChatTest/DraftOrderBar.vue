        ...
        <div class="header">
            ...
            <div class="draft-info">
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">{{ currentPick +1}} of {{ totalPicks }}</div>
                </div>
                <div class="info-item">
...
export default {
    ...
    props: {
        draftQueue:{
            type: Object,
            default: {
                0: {user: {id: 5,username: 'Cond1tion'}, player: {team: 'T1', summonerName: 'Faker'}},
                1: {user: {id: 6,username: 'SlyMarb0'}, player: {team: 'GEN', summonerName: 'Ruler'}},
                2: {user: {id: 7,username: 'Konjix'}, player: {team: 'GEN', summonerName: 'Chovy'}},
                3: {user: {id: 8,username: 'Hakkene'}, player: {team: 'GEN', summonerName: 'Canyon'}},
                4: {user: {id: 8,username: 'Hakkene'}, player: {team: 'T1', summonerName: 'Faker'}},
                5: {user: {id: 7,username:'Konjix'}, player: {team:'GEN', summonerName:'Ruler'}},
