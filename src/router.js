...
import MatchPointsView from "./views/MatchPointsView.vue";
...
const routes = [
  ...
  { name: "StandingsView", path: "/standings", component: StandingsView },
  ...
  },
  {
    ...
    path: "/match-points/:matchId",
    component: MatchPointsView,
  },
  {
    name: "GamePointsView",
